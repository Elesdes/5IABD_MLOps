...
@pipeline(enable_cache=False, name="Local Train Pipeline")
def local_train_pipeline() -> None:
    """
    Local Training Pipeline for data preparation, model training, and evaluation.

    This function implements a complete machine learning workflow, running locally on the user's machine.
    ...
    The function completes the workflow from data preparation to model evaluation, running entirely locally.
